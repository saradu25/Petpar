...
<head>
    ...
    <title>PetPar - Instituição</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="css/dashboards.css">
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">PetPar - Instituição</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
                <a href="animalRegister.jsp" class="nav-link" >Cadastrar novo animal</a>
            </li>
            <li class="nav-item">
                <a href="animalList.jsp" class="nav-link">Ver lista de animais</a>
            </li>
            <li class="nav-item">
                <a href="donations.jsp" class="nav-link" href="#">Ver doações</a>
            </li>
<%--            <li class="nav-item">--%>
...
<div class="container-fluid vh-100 d-flex align-items-center justify-content-center bg-custom">
    <div class="row w-100">
        ...
        <div class="col-md-6 d-flex flex-column justify-content-center align-items-center text-white">
            ...
            <p class="lead">Gerencie a sua Instituição aqui!</p>
        </div>
    </div>
</div>
